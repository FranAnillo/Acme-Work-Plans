...
<acme:form>
	...
	<acme:form-submit code="workplan.form.button.create" action="/manag/workplan/create"/>
  	<acme:form-return code="workplan.form.button.return"/>
  	<acme:form-submit code="workplan.form.button.delete" action="/manag/workplan/delete"/>
